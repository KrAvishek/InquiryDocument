...
export function constructMetadata({
  title = "InquiryDoc - the SaaS for students",
  description = "InquiryDoc is an open-source software to make chatting to your PDF files easy.",
  image = "/thumbnail.png",
  icons = "/favicon.ico",
  noIndex = false
}: {
  ...
  return {
    ...
    icons,
    metadataBase: new URL('https://inquiry-document.vercel.app/'),
    ...(noIndex && {
      robots: {
        index: false,
        follow: false
